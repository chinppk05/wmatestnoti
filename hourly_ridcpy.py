...
while (counter < len(station_id)):
    url = "http://wq-chaophraya.rid.go.th/api/stat?siteId="+str(station_id[counter])+"&period=60&fromDate="+str(nowja.year)+"-"+str(nowja.month)+"-"+str(nowja.day)+"&toDate="+str(nowja.year)+"-"+str(nowja.month)+"-"+str(nowja.day+1)
    payload={}
    headers = {
